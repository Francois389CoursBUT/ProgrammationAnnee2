...
public class TestNoeud {
    ...
    /**
     * Méthode qui crée un noeud racine et insÃ¨re toutes les valeus du
     * tableau argument. La premiÃ¨re valeur sera celle du noeud racine
     * @param valeursAInserer  entiers Ã  insérer Ã  partir du noeud racine
    ...
    /**
     * Cette méthode teste la méthode estPresente dans le cas oÃ¹ le noeud n'a pas
     * de descendant
     * Elle ne teste pas toutes les opérations Ã  effectuer lors de la création
     */
    ...
    public static void testInserer() {
        ...
        for (int valeur : A_INSERER) {
            if (noeud.inserer(valeur)) {
                System.out.println("Test NOK : insertion de " + valeur + " alors que déjÃ  présente");
            } else {
                nbTestOk++;
            }
        }
